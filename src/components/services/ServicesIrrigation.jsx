import Irrigation from "../../assets/images/irrigation/11.jpg";
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between items-start gap-10">
          ...
          <div className="flex-1 flex justify-center relative">
            <div className='w-full'>
              <img className="w-full rounded-2xl h-[500px]" src={Irrigation} alt="Polyhouse" />
            </div>
            {/* Small Logo Image */}
            <div className="absolute top-4 right-4">
              <img className="w-[42px] h-[42px]" src={Logo} alt="Icon" />
            </div>
          </div>
        </div>
      </div>
