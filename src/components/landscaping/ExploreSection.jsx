import img1 from "../../assets/images/landscaping/image_1.svg";
import img2 from "../../assets/images/landscaping/image_2.svg";
import img3 from "../../assets/images/landscaping/image_3.svg";
      ...
      <div className="flex flex-col gap-16">
        <div className="flex flex-col md:flex-row justify-start items-start gap-12">
          ...
          <div className="flex-1 flex flex-col justify-start items-start gap-6">
            <img className="w-12 h-11 " src={img1} alt="Landscape Image"/>
          ...
          <div className="flex-1 flex flex-col justify-start items-start gap-6">
            ...
            <img className="w-12 h-11 " src={img2} alt="Landscape Image"/>
            </div>
            <h3 className="text-black text-2xl font-bold leading-10">
          ...
          {/* Service 3 */}
          <div className="flex-1 flex flex-col justify-start items-start gap-6">
          <img className="w-12 h-11 " src={img3} alt="Landscape Image"/>
            <h3 className="text-black text-2xl font-bold leading-10">
